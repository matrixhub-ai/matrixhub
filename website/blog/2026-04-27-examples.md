...
3. Click the top-right user menu, then go to Platform Settings and Repository Management.

![](/img/blog/scenario-test-en/scenario-test-en-6.png)

4. Create a target repository: select Hugging Face as the provider, set the repository name to `hf`, enter the target URL `https://hf-mirror.com`, enable remote certificate verification, and click `OK`.
