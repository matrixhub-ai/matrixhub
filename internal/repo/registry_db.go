...
func NewRegistryDB(db *gorm.DB) *RegistryDBRepo {
...
func (r *RegistryDBRepo) GetRegistry(ctx context.Context, id int) (*registry.Registry, error) {
...
func (r *RegistryDBRepo) DeleteRegistry(ctx context.Context, id int) error {
